...
def build_deck():
    ...
    create_card(s4, Inches(8.7), Inches(2.0), Inches(3.8), Inches(4.5), "3. 소화기 질병 상시화", 
                ["송아지 설사병(로타·코로나 등) 및 콕시듐증 지속", "정부 무항생제 축산 정책 강화", "착유우 곰팡이독소 원유 전이 위험 및 번식 장애", "천연 방어 솔루션 도입 시급"], tag="방역 위기")
    add_footer(s4, prs, 4)
    ...
    create_card(s8, Inches(8.7), Inches(2.0), Inches(3.8), Inches(4.5), "서울우유협동조합 (수요처)", 
    ...
    create_card(s13, Inches(6.8), Inches(2.0), Inches(5.7), Inches(4.5), "원가 대비 파급 효과", 
                ["사료 톤당 3,000원 투입으로 얻는 가치:",
                 "1. FCR 및 소화율 개선 -> 사료비 톤당 약 15,000원 절감 효과",
                 "2. 송아지 폐사율 및 설사 방어 -> 목장 육성비 수천만원 보호",
                 "3. 착유우 산유량 방어 및 체세포수 1등급 -> 최고 등급 유대 인센티브 수령",
                 "즉, 1원 투자 대비 5.2원의 경제적 환원 가치 창출 (ROI 1:5.2)"], tag="투자 대비 수익(ROI)")
    ...
    create_card(s21, Inches(6.8), Inches(2.0), Inches(5.7), Inches(4.5), "적용 효과 및 악취 저감", 
                ["사료 제조 펠렛 열(90℃) 및 위산 통과 후 소장·대장에서 100% 발아",
                 "어린 송아지 연변·설사 발생률 80% 이상 획기적 억제",
                 "장내 부패균 증식 억제로 분변 내 유해가스 발생 원천 차단",
                 "우사 내 암모니아(NH3) 가스 40~50% 저감으로 축산 환경 쾌적화"], tag="PROVEN RESULTS")
    ...
    add_header(s28, prs, "PART VI. 기대효과 및 로드맵", "낙농 목장 정량적 기대효과 및 생산성 향상", "착유우 및 육성우 목장의 실질적인 소득 증대와 서울우유 브랜드 가치 제고")
    
    livestock_cards = [
        ("낙농 (착유우)", ["하절기 고온 스트레스 방어", "건물섭취량(DMI) 1.5kg 유지", "일 산유량 +1.8kg 유지", "비유 피크 지속 기간 연장"], "착유 목장"),
        ("원유 유질 개선", ["체세포수(SCC) 42% 급감", "평균 18.5만/ml 1등급 달성", "임상형 유방염 65% 저감", "폐유 손실 70% 감소"], "유질 관리"),
        ("육성우 & 송아지", ["송아지 설사 발생 80% 저감", "반추위 융모 발달 35% 증대", "초산일령 1.5개월 조기 단축", "육성비 두당 45만원 절감"], "육성우 목장"),
        ("목장 종합 ROI", ["사료 톤당 단 3,000원 투자", "톤당 15,600원 가치 회수", "투자비 대비 5.2배 순익 회수", "서울우유 사료 만족도 99%"], "경제성 가치")
    ]
