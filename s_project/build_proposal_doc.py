...
def create_document():
    ...
    toc_items = [
        ...
        ("제 6 장. 기대 효과 및 실행 로드맵 (Roadmap & Technical Support)", [
            "6.1 축종별(한우/비육우, 낙농, 양돈, 양계) 생산성 및 FCR 개선 목표치",
    ...
    solutions = [
        ("4.1 [제1군] 기호성 증진 복합 향미·감미제 솔루션 (DDC 특화 라인)",
         ...
         "500g/ton 처방으로 초기 섭취량(ADFI) 8~15% 개선, 조기 이유 스트레스 및 비육우 섭취 정체 해소."),
    ...
    r_data = [
        ("한우 / 비육우", "초기 섭취량 조기 확보, 반추위 발효 안정화, 육질 등급 향상", "일당증체량(ADG) 8%↑, 1++등급 출현율 12%↑"),
        ("낙 농 (착유우)", "하절기 고온 스트레스 방어, 건물섭취량(DMI) 유지, 유량 유지", "산유 피크 2주 연장, 체세포수 25% 감소"),
        ("양 돈 (자돈/비육)", "이유자돈 설사율 차단, FCR 개선, 출하일령 단축", "자돈 폐사율 제로화, 출하일령 5~7일 단축, FCR 0.1↓"),
        ("양 계 (산란/육계)", "난각 품질 개선, 장관 콕시듐/괴사성장염 억제, 폐사율 감소", "파란율 1.5%↓, 산란율 피크 지속, 균일도 90%↑")
    ]
